...
public interface InvestProductMapper extends BaseMapper<InvestProduct> {
    ...
    IPage<InvestProduct> findAll(@Param("criteria") InvestProductQueryCriteria criteria, Page<Object> page);

    List<InvestProduct> findAll(@Param("criteria") InvestProductQueryCriteria criteria);
}