...
public class GymCourseInfoController {

    private final GymCourseInfoService gymCourseInfoService;

    @Log("导出数据")
    @ApiOperation("导出数据")
    @GetMapping(value = "/download")
    @PreAuthorize("@el.check('jljsCourseInfo:list')")
    public void exportJljsCourseInfo(HttpServletResponse response, GymCourseInfoQueryCriteria criteria) throws IOException {
        gymCourseInfoService.download(gymCourseInfoService.queryAll(criteria), response);
    }
    ...
    public ResponseEntity<Object> createJljsCourseInfo(@Validated @RequestBody GymCourseInfo resources){
        gymCourseInfoService.create(resources);
    ...
    public ResponseEntity<Object> updateJljsCourseInfo(@Validated @RequestBody GymCourseInfo resources){
        gymCourseInfoService.update(resources);
    ...
    public ResponseEntity<Object> deleteJljsCourseInfo(@RequestBody List<String> ids) {
        gymCourseInfoService.deleteAll(ids);
