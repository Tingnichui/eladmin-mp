...
**/
@Data
@TableName("gym_contract_operate_record")
public class GymContractOperateRecord extends BaseEntity implements Serializable {
    ...
    public void copy(GymContractOperateRecord source){
